...
// ── Paletas de color ─────────────────────────────────
// c1HueDeg: grados de hue-rotate para colorear el emoji ⭕ al color de c1.
// Base sepia ≈ hue 30°, así que c1HueDeg = hue_objetivo - 30.
var PALETAS = [
    {
        nombre:       'ORIGINAL',
...
function aplicarPaleta(p) {
    ...
    // Colorear el emoji ⭕ del Tic Tac Toe al color de c1
...
function actualizarVista() {
    ...
    pantallaTTT.style.display =
        (!esMenu && estado.juegoActivo === 'tic-tac-toe') ? '' : 'none';
}

// ── Event Listeners de navegación ───────────────────

document.querySelector('[data-juego="tic-tac-toe"]').addEventListener('click', function () {
    TicTacToe.reiniciar();
